...
setclipboard('https://v3vn.cfd/discord.php?H=VN')
end)
Main_Page:Button('Copy Link Discord Store [Parter]',function()
setclipboard('https://v3vn.cfd/discord.php?H=v3vn')
end)
Main_Page:Seperator(" 🔰 Infomation ")
Main_Page:Label("Developer : ZeroTNgaming")
Main_Page:Label("Script type : Free")
Main_Page:Label("Script language : Eng ")
Main_Page:Label("Script Version : 1.0.0 ")
